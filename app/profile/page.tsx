...
export default function Profile() {
  ...
  const recentActivities = [
    {
      id: "1",
      type: "event",
      title: "Joined Juhu Beach Cleanup",
      points: 50,
      streakBonus: 25,
      date: "2025-01-10",
      icon: Recycle,
    },
    {
      id: "2",
      type: "scan",
      title: "Scanned Khadi Cotton Kurta",
      points: 10,
      streakBonus: 5,
      date: "2025-01-08",
      icon: Scan,
    },
    {
      id: "3",
      type: "badge",
      title: "Earned 'Earth Day Champion' Badge",
      points: 100,
      streakBonus: 0,
      date: "2025-01-05",
      icon: Award,
    },
    {
      id: "4",
      type: "event",
      title: "Completed Tree Planting at Sanjay Gandhi National Park",
      points: 75,
      streakBonus: 37,
      date: "2025-01-03",
      icon: TreePine,
  ...
  }, [currentStreak]) // Removed recentActivities from the dependency array
                    ...
                    return (
                      ...
                      >
                        <div className="text-center">
                          ...
                          <Badge variant={getRarityBadge(badge.rarity) as any} className="mb-2 capitalize">
                            {badge.rarity}
                          </Badge>
